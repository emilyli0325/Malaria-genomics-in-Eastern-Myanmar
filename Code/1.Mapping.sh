...
./bwa mem ./Index/Pfal3D7_hg19.fa ${1}.R1.fastq.gz ${1}.R2.fastq.gz -t 12 -M -R "@RG\tID:${1}\tLB:${1}\tPL:ILLUMINA\tPM:HISEQ\tSM:${1}" > SAM/${1}.sam
...
echo "BQSR ${1}..."	 
    ...
    java -jar /master/xli/software/IGV/IGVTools/igvtools.jar count \
         recal.bam/${1}.recal.bam \
         TDF/${1}.tdf \
         /master/xli/igv/genomes/Pf3D7_v9.0.genome
		 
echo "Variant ploidy 2 calling ${1}..."
	java -Xmx20g -jar /master/xli/software/GATK/GenomeAnalysisTK.jar\
         -T HaplotypeCaller\
         -R /data/infectious/malaria_XUE/sWGA/Index/Pfal3D7_hg19.fa\
